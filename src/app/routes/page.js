...
const Route = () => {
  return (
    <div>
      ...
      <Banner
        title="routes"
        headingLine1="Comprehensive Routes for Every Traveler"
        headingLine2="Reaching Your Destination with Ease"
        descriptionLine1="MM Taxi offers reliable routes across the city and beyond, connecting you to key locations."
        descriptionLine2=" Our service ensures a smooth and timely journey, wherever you're headed."
      />
...
export const metadata = {
  ...
  description:
    "Explore our affordable and transparent pricing for various routes including Jeddah, Makkah, Madina, and more. Choose from a range of vehicles to suit your needs for Umra transportation.",
  keywords: [
    "Umra taxi routes",
  ...
  openGraph: {
    title: "Umra Taxi Service Routes and Pricing | MM Taxi Service",
    description:
      "Check out our detailed route and pricing list for all your Umra transportation needs. We offer competitive rates for all major routes including Jeddah, Makkah, Madina, and more.",
  ...
  twitter: {
    ...
    title: "Umra Taxi Service Routes and Pricing | MM Taxi Service",
    description:
      "Explore competitive pricing for all Umra taxi routes. Choose the best option for your travel needs with MM Taxi Service.",
