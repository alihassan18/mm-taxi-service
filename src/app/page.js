...
export const metadata = {
  ...
  description:
    "Book your Umrah and Hajj taxi services online with us. We offer reliable and affordable rides from Makkah to Madinah and other destinations.",
  keywords: [
    "Umra taxi service",
    "Saudi Arabia",
    "airport transfers",
    ...
    "Umrah and Hajj taxi services",
  ],
  author: "MM Taxi Service",
  robots: "index, follow",
  viewport: "width=device-width, initial-scale=1.0",
  openGraph: {
    canonical: "https://www.mmtaxiservice.com",
    title: "Book Umrah and Hajj Taxi Services Online | MM Taxi Service",
    description:
      "Book your Umrah and Hajj taxi services online with us. We offer reliable and affordable rides from Makkah to Madinah and other destinations.",
