...
export const generateMetadata = ({ params }) => {
  ...
  if (post) {
    return {
      ...
      description:
        post.postDetails.excerpt || "Default description for blog posts.",
      keywords: post.keywords || ["default", "keywords"],
      author: post.author || "MM Taxi Service",
      openGraph: {
        title: post.title,
        description: post.postDetails.excerpt,
        url: `https://www.mmtaxiservice.com/blog/${slug}`,
        image:
          post.postDetails.postThumb.imgSrc ||
          "https://www.mmtaxiservice.com/assets/img/default.jpg",
      },
      twitter: {
        card: "summary",
        title: post.title,
      ...
      canonical: `https://www.mmtaxiservice.com/blog/${slug}`,
    };
  }
                  ...
                  <li>
                    {prevPost && (
                      <a href={`/blog/${prevPost.slug}`}>
                        <span>
                          <i className="las la-angle-left"></i> {prevPost.text}
                        </span>
                      </a>
                    )}
                  </li>
                  <li className="next">
                    {nextPost && (
                      <a href={`/blog/${nextPost.slug}`}>
                        <span>
                          {nextPost.text} <i className="las la-angle-right"></i>
                        </span>
                      </a>
                    )}
                  </li>
